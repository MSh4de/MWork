...
public class IntegerArrayBinaryTagBuffer implements NameTagBuffer<IntegerArrayBinaryTag> {

    @Override
    public void write(NameTagBufferDriver nameTagBufferDriver, DataOutputStream outputStream, IntegerArrayBinaryTag integerArrayBinaryTag) throws Exception {
