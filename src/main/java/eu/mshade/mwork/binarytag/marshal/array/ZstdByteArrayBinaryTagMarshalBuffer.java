...
public class ZstdByteArrayBinaryTagMarshalBuffer extends ByteArrayBinaryTagMarshalBuffer {
    ...
    public BinaryTag<?> serialize(BinaryTagMarshal binaryTagMarshal, Type type, Object o, ParameterContainer parameterContainer) throws Exception {
        return ((ByteArrayBinaryTag) super.serialize(binaryTagMarshal, type, o, parameterContainer)).toZstd();
    }
