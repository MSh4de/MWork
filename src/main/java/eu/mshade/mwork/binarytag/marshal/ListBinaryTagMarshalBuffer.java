...
public class ListBinaryTagMarshalBuffer implements BinaryTagMarshalBuffer<Object> {
    ...
    public BinaryTag<?> serialize(BinaryTagMarshal binaryTagMarshal, Type type, Object o, ParameterContainer parameterContainer) throws Exception {
        ...
        for (Object object : objects) {
            listBinaryTag.add(binaryTagMarshalBuffer.serialize(binaryTagMarshal, typeArgument, object, parameterContainer));
        }
    ...
    public Object deserialize(BinaryTagMarshal binaryTagMarshal, Type type, BinaryTag<?> binaryTag, ParameterContainer parameterContainer) throws Exception {
        ...
        for (BinaryTag<?> tag : listBinaryTag) {
            objects.add(binaryTagMarshalBuffer.deserialize(binaryTagMarshal, model, tag, parameterContainer));
        }
        return objects;
    }
}
